...
void ec_pPoint_init_name(EC_pPoint *rop, const EC_pName name) {
	...
	switch(name) {
		case brainpoolP160r1:
			mpz_set_str(rop->x, "BED5AF16EA3F6A4F62938C4631EB5AF7BDBCDBC3", 16);
			mpz_set_str(rop->y, "1667CB477A1A8EC338F94741669C976316DA6321", 16);	
			return;
		case brainpoolP160t1:
			mpz_set_str(rop->x, "B199B13B9B34EFC1397E64BAEB05ACC265FF2378", 16);
			mpz_set_str(rop->y, "ADD6718B7C7C1961F0991B842443772152C9E0AD", 16);	
			return;	
		case brainpoolP192r1:
			mpz_set_str(rop->x, "C0A0647EAAB6A48753B033C56CB0F0900A2F5C4853375FD6", 16);
			mpz_set_str(rop->y, "14B690866ABD5BB88B5F4828C1490002E6773FA2FA299B8F", 16);	
			return;
		case brainpoolP192t1:
			mpz_set_str(rop->x, "3AE9E58C82F63C30282E1FE7BBF43FA72C446AF6F4618129", 16);
			mpz_set_str(rop->y, "097E2C5667C2223A902AB5CA449D0084B7E5B3DE7CCC01C9", 16);	
			return;
		case brainpoolP224r1:
			mpz_set_str(rop->x, "0D9029AD2C7E5CF4340823B2A87DC68C9E4CE3174C1E6EFDEE12C07D", 16);
			mpz_set_str(rop->y, "58AA56F772C0726F24C6B89E4ECDAC24354B9E99CAA3F6D3761402CD", 16);	
			return;
		case brainpoolP224t1:
			mpz_set_str(rop->x, "6AB1E344CE25FF3896424E7FFE14762ECB49F8928AC0C76029B4D580", 16);
			mpz_set_str(rop->y, "0374E9F5143E568CD23F3F4D7C0D4B1E41C8CC0D1C6ABD5F1A46DB4C", 16);	
			return;
		case brainpoolP256r1:
			mpz_set_str(rop->x, "8BD2AEB9CB7E57CB2C4B482FFC81B7AFB9DE27E1E3BD23C23A4453BD9ACE3262", 16);
			mpz_set_str(rop->y, "547EF835C3DAC4FD97F8461A14611DC9C27745132DED8E545C1D54C72F046997", 16);	
			return;
		case brainpoolP256t1:
			mpz_set_str(rop->x, "A3E8EB3CC1CFE7B7732213B23A656149AFA142C47AAFBC2B79A191562E1305F4", 16);
			mpz_set_str(rop->y, "2D996C823439C56D7F7B22E14644417E69BCB6DE39D027001DABE8F35B25C9BE", 16);	
			return;
		case brainpoolP320r1:
			mpz_set_str(rop->x, "43BD7E9AFB53D8B85289BCC48EE5BFE6F20137D10A087EB6E7871E2A10A599C710AF8D0D39E20611", 16);
			mpz_set_str(rop->y, "14FDD05545EC1CC8AB4093247F77275E0743FFED117182EAA9C77877AAAC6AC7D35245D1692E8EE1", 16);	
			return;
		case brainpoolP320t1:
			mpz_set_str(rop->x, "925BE9FB01AFC6FB4D3E7D4990010F813408AB106C4F09CB7EE07868CC136FFF3357F624A21BED52", 16);
			mpz_set_str(rop->y, "63BA3A7A27483EBF6671DBEF7ABB30EBEE084E58A0B077AD42A5A0989D1EE71B1B9BC0455FB0D2C3", 16);	
			return;
		case brainpoolP384r1:
			mpz_set_str(rop->x, "1D1C64F068CF45FFA2A63A81B7C13F6B8847A3E77EF14FE3DB7FCAFE0CBD10E8E826E03436D646AAEF87B2E247D4AF1E", 16);
			mpz_set_str(rop->y, "8ABE1D7520F9C2A45CB1EB8E95CFD55262B70B29FEEC5864E19C054FF99129280E4646217791811142820341263C5315", 16);	
			return;
		case brainpoolP384t1:
			mpz_set_str(rop->x, "18DE98B02DB9A306F2AFCD7235F72A819B80AB12EBD653172476FECD462AABFFC4FF191B946A5F54D8D0AA2F418808CC", 16);
			mpz_set_str(rop->y, "25AB056962D30651A114AFD2755AD336747F93475B7A1FCA3B88F2B6A208CCFE469408584DC2B2912675BF5B9E582928", 16);	
			return;
		case brainpoolP512r1:
			mpz_set_str(rop->x, "81AEE4BDD82ED9645A21322E9C4C6A9385ED9F70B5D916C1B43B62EEF4D0098EFF3B1F78E2D0D48D50D1687B93B97D5F7C6D5047406A5E688B352209BCB9F822", 16);
			mpz_set_str(rop->y, "7DDE385D566332ECC0EABFA9CF7822FDF209F70024A57B1AA000C55B881F8111B2DCDE494A5F485E5BCA4BD88A2763AED1CA2B2FA8F0540678CD1E0F3AD80892", 16);	
			return;
		case brainpoolP512t1:
			mpz_set_str(rop->x, "640ECE5C12788717B9C1BA06CBC2A6FEBA85842458C56DDE9DB1758D39C0313D82BA51735CDB3EA499AA77A7D6943A64F7A3F25FE26F06B51BAA2696FA9035DA", 16);
			mpz_set_str(rop->y, "5B534BD595F5AF0FA2C892376C84ACE1BB4E3019B71634C01131159CAE03CEE9D9932184BEEF216BD71DF2DADF86A627306ECFF96DBB8BACE198B61E00F8B332", 16);	
			return;
		case secp192k1:
			mpz_set_str(rop->x, "DB4FF10EC057E9AE26B07D0280B7F4341DA5D1B1EAE06C7D", 16);
			mpz_set_str(rop->y, "9B2F2F6D9C5628A7844163D015BE86344082AA88D95E2F9D", 16);	
			return;
		case secp192r1:
			mpz_set_str(rop->x, "188DA80EB03090F67CBF20EB43A18800F4FF0AFD82FF1012", 16);
			mpz_set_str(rop->y, "07192B95FFC8DA78631011ED6B24CDD573F977A11E794811", 16);	
			return;
		case secp224k1:
			mpz_set_str(rop->x, "A1455B334DF099DF30FC28A169A467E9E47075A90F7E650EB6B7A45C", 16);
			mpz_set_str(rop->y, "7E089FED7FBA344282CAFBD6F7E319F7C0B0BD59E2CA4BDB556D61A5", 16);	
			return;
		case secp224r1:
			mpz_set_str(rop->x, "B70E0CBD6BB4BF7F321390B94A03C1D356C21122343280D6115C1D21", 16);
			mpz_set_str(rop->y, "BD376388B5F723FB4C22DFE6CD4375A05A07476444D5819985007E34", 16);	
			return;
		case secp256k1:
			mpz_set_str(rop->x, "79BE667EF9DCBBAC55A06295CE870B07029BFCDB2DCE28D959F2815B16F81798", 16);
			mpz_set_str(rop->y, "483ADA7726A3C4655DA4FBFC0E1108A8FD17B448A68554199C47D08FFB10D4B8", 16);	
			return;
		case secp256r1:
			mpz_set_str(rop->x, "6B17D1F2E12C4247F8BCE6E563A440F277037D812DEB33A0F4A13945D898C296", 16);
			mpz_set_str(rop->y, "4FE342E2FE1A7F9B8EE7EB4A7C0F9E162BCE33576B315ECECBB6406837BF51F5", 16);	
			return;
		case secp384r1:
			mpz_set_str(rop->x, "AA87CA22BE8B05378EB1C71EF320AD746E1D3B628BA79B9859F741E082542A385502F25DBF55296C3A545E3872760AB7", 16);
			mpz_set_str(rop->y, "3617DE4A96262C6F5D9E98BF9292DC29F8F41DBD289A147CE9DA3113B5F0B8C00A60B1CE1D7E819D7A431D7C90EA0E5F", 16);	
			return;
		case secp521r1:
			mpz_set_str(rop->x, "00C6858E06B70404E9CD9E3ECB662395B4429C648139053FB521F828AF606B4D3DBAA14B5E77EFE75928FE1DC127A2FFA8DE3348B3C1856A429BF97E7E31C2E5BD66", 16);
			mpz_set_str(rop->y, "011839296A789A3BC0045C8A5FB42C7D1BD998F54449579B446817AFBD17273E662C97EE72995EF42640C550B9013FAD0761353C7086A272C24088BE94769FD16650", 16);	
			return;										
		default: 
			return;	
	}
